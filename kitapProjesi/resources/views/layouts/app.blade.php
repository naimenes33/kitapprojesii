...
<div class="top-header">
				...
				<div class="col-md-6 top-header-left">
					<div class="cart box_1">
						<a href="{{route('basket.index')}}">
							 <div class="total">
								<span style="font-size: 13px;"></span>{{\App\Helper\sepetHelper::totalPrice()}} TL</div>
								<img src="{{asset('images/cart-1.png')}}" alt="" />
						</a>
						<p><a href="{{route('basket.flush')}}" class="simpleCart_empty">Temizle sepeti</a></p>
						<div class="clearfix"> </div>
					</div>
				</div>
				<div class="clearfix"></div>
	...
	<!--start-logo-->
	<div class="logo">
		<a href="{{route('index')}}"><h1>Kitap diyarı.com</h1></a>
	</div>
	<!--start-logo-->
	<!--bottom-header-->
